...
onMounted(async () => {
    try {
        ...
        console.error('Error fetching the job from json-server', error);
    } finally {
...
<template>
    <BackButton button-link="/jobs" button-text="Back to jobs list"/>
            ...
            <div class="grid grid-cols-1 md:grid-cols-70/30 w-full gap-6">
                <main>
                    <div class="bg-white p-6 rounded-lg shadow-md text-center md:text-left">
                        ...
                        <div class="text-gray-500 mb-4 flex align-middle justify-center md:justify-start">
                            ...
                            <p class="pi pi-map-marker text-orange-700">{{ state.job.location }}</p>
                        </div>
                    </div>
                ...
                <aside>
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-md">
                        ...
                        <p class="my-2">
                            {{ state.job.company.description }} </p>
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-md mt-6">
                        ...
                        <RouterLink :to="`/jobs/edit/${Number(jobId)}`"
